...
public class ControllerPageFirmPosition
{
    ...
    public ControllerPageFirmPosition() {
        try{
    ...
    public void onUpdateClick(MouseEvent mouseEvent)
    {
        ...
        FXMLLoader loader = new FXMLLoader(getClass().getResource("fxml/update_position.fxml"));
        loader.setControllerFactory(c -> {
            return new ControllerUpdatePosition(this, positionD);
        });
        Parent root1 = null;
        try {
            root1 = loader.load();
    ...
    {
        FXMLLoader loader = new FXMLLoader(getClass().getResource("fxml/add_position.fxml"));
        loader.setControllerFactory(c -> {
            return new ControllerAddPosition(this);
        });
        Parent root1 = null;
        try {
            root1 = loader.load();
