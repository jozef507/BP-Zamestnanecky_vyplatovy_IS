...
public class ControllerPageLegislationLevel
{
    ...
    public ControllerPageLegislationLevel() {
        try{
            levelDS = levelSelect();
        } catch (IOException e) {
            e.printStackTrace();
    ...
    public void onUpdateClick(MouseEvent mouseEvent)
    {
        ...
        FXMLLoader loader = new FXMLLoader(getClass().getResource("fxml/update_level.fxml"));
        loader.setControllerFactory(c -> {
            return new ControllerUpdateLevel(this, levelD);
        });
        Parent root1 = null;
        try {
            root1 = loader.load();
    ...
    {
        FXMLLoader loader = new FXMLLoader(getClass().getResource("fxml/add_level.fxml"));
        loader.setControllerFactory(c -> {
            return new ControllerAddLevel(this);
        });
        Parent root1 = null;
        try {
            root1 = loader.load();
