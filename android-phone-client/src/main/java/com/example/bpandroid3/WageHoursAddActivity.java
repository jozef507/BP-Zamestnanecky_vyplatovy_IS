package com.example.bpandroid3;
...
public class WageHoursAddActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_wage_hours_add);

        wageD = new WageD();
        wageD.setId(getIntent().getStringExtra("zm_id"));
        wageD.setTimeImportant(getIntent().getStringExtra("nutne_evidovanie_casu"));
        wageD.setEmergencyImportant(getIntent().getStringExtra("mozne_evidovanie_pohotovosti"));
        wageD.setWageFormName(getIntent().getStringExtra("nazov"));
        conditionsID = getIntent().getStringExtra("conditionsID");

        dateBox = findViewById(R.id.date_box);
        timeBox = findViewById(R.id.time_box);
        emergencyBox = findViewById(R.id.emergency_box);
        overtimeBox = findViewById(R.id.overtime_box);
        performanceBox = findViewById(R.id.performance_box);
        partBox = findViewById(R.id.part_box);
        ...
        emergencyType = findViewById(R.id.emergency_type);
    ...
    private class MyUploadTask extends AsyncTask<String, Void, HttpClient>
    {
        ...
        protected void onPostExecute(HttpClient a) {
            ...
            {
                Toast.makeText( getApplicationContext(),"Pridanie odpracovaného výkonu prebehlo úspešne!", Toast.LENGTH_LONG).show();
                finish();
            }
        }
    }
